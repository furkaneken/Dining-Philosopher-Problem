...
public class Philosopher extends Thread {
	...
	public Philosopher(int i, Semaphore [] s, int [] mystate, int philnumber, Semaphore mu, Semaphore[] bar) throws InterruptedException {
		id = i;
		sem = s;
		state = mystate;
		N = philnumber;
	...
	public static void main(String args[]) throws InterruptedException {
		...
		for (int i=0; i < N; i++)
		{
			semarray[i] = new Semaphore(1,true);
